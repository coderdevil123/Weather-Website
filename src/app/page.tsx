...
export default function Page() {
  ...
  const apiKey = "894beaad98ab419a7b3814d1a907cdd8"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        {/* Search Input */}
        <Card className="backdrop-blur-xl bg-black/20 border-white/10 shadow-2xl ring-1 ring-white/5 transition-all hover:scale-105">
          <CardContent className="p-6">
            <div className="relative group">
              ...
              <Input
                ...
                className="pl-12 pr-4 py-3 bg-white/5 border-white/10 text-white placeholder:text-gray-400 rounded-xl text-lg"
              />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-8">
            ...
            <div className="flex items-center justify-center mb-8">
              <div className="text-center">
                <div className="relative mb-6">
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-400/20 to-blue-400/20 rounded-full blur-2xl animate-pulse" />
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              {weatherDetails.map((item, index) => (
                <div
                  key={index}
                  className="backdrop-blur-sm bg-white/5 rounded-2xl p-4 border border-white/10 hover:bg-white/10 transition-all group"
                >
            ...
            <Button
              ...
              className="w-full mt-8 bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-xl font-semibold text-lg shadow-lg hover:scale-105 transition-all"
            >
              Get Weather
            </Button>
          </CardContent>
